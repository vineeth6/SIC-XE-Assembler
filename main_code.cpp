...
void cli__main_menu()
{
    ...
    while (cli_user_choice <= 6)
    {
        ...
        cout << "2. Encrypt Object Code\n";
        cout << "3. Decrypt Object Code\n";
        cout << "4. Quit\n"
             << flush;
        cout << "\n> Enter your choice: ";
...
int cli__run_program()
{
    ...
    string assembly_filename = "input_assembly_file.txt";
    string instructions_filename = "instructions.txt";
    string registers_filename = "registers.txt";
    string assembler_directives_filename = "assembler_directives.txt";

    strcpy(cli_data.input_filename , assembly_filename.c_str());
    ...
    /*cout << "\n> Enter Instruction File Name: ";*/
    strcpy(cli_data.instructions_filename, instructions_filename.c_str());
    ...
    /*cout << "\n> Enter Register File Name: ";*/
    strcpy(cli_data.registers_filename, registers_filename.c_str());
    ...
    strcpy(cli_data.assembler_directives_filename, assembler_directives_filename.c_str());
